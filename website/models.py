...
class FISFaculty(db.Model, UserMixin):
    ...
    FISPDS_EducationalBackground_Additional = db.relationship('FISPDS_EducationalBackground_Additional')
    ...
    def to_dict(self):
        return {
            ...
            'FISPDS_EducationalBackground_Additional': self.FISPDS_EducationalBackground_Additional,
...
class FISPDS_EducationalBackground(db.Model):
    ...
    ESchoolName = db.Column(db.String(50))  
    EAttendancePeriod_From = db.Column(db.Integer)  
    EAttendancePeriod_To = db.Column(db.Integer)  
    EYearGraduated = db.Column(db.Integer)  
    EScholarshi_Honor = db.Column(db.String(50)) 
    
    SSchoolName = db.Column(db.String(50))  
    SAttendancePeriod_From = db.Column(db.Integer)  
    SAttendancePeriod_To = db.Column(db.Integer)  
    SYearGraduated = db.Column(db.Integer)  
    SScholarshi_Honor = db.Column(db.String(50)) 
    
    CSchoolName = db.Column(db.String(50))  
    CBasicEducation = db.Column(db.String(50))  
    CAttendancePeriod_From = db.Column(db.Integer)  
    CAttendancePeriod_To = db.Column(db.Integer)  
    CUnits = db.Column(db.String(50))  
    CYearGraduated = db.Column(db.Integer)  
    CScholarshi_Honor = db.Column(db.String(50)) 
    ...
    def to_dict(self):
        return {
            ...
            'FacultyId': self.FacultyId,
            'AdminId': self.AdminId,
            'ESchoolName': self.ESchoolName,
            'EAttendancePeriod_From': self.EAttendancePeriod_From,
            'EAttendancePeriod_To': self.EAttendancePeriod_To,
            'EYearGraduated': self.EYearGraduated,
            'EScholarshi_Honor': self.EScholarshi_Honor,
            
            'SSchoolName': self.SSchoolName,
            'SAttendancePeriod_From': self.SAttendancePeriod_From,
            'SAttendancePeriod_To': self.SAttendancePeriod_To,
            'SYearGraduated': self.SYearGraduated,
            'SScholarshi_Honor': self.SScholarshi_Honor,
            
            'CSchoolName': self.CSchoolName,
            'CBasicEducation': self.CBasicEducation,
            'CAttendancePeriod_From': self.CAttendancePeriod_From,
            'CAttendancePeriod_To': self.CAttendancePeriod_To,
            'CUnits': self.CUnits,
            'CYearGraduated': self.CYearGraduated,
            'CScholarshi_Honor': self.CScholarshi_Honor,
...
class FISPDS_EducationalBackground_Additional(db.Model):
    __tablename__ = 'FISPDS_EducationalBackground_Additional'
    ...
    YearGraduated = db.Column(db.Integer)  
    From = db.Column(db.Integer)  
    To = db.Column(db.Integer)  
    Scholarshi_Honor = db.Column(db.String(50)) 
    is_delete = db.Column(db.Boolean, default=False) 
    ...
    def to_dict(self):
        return {
            ...
            'Degree': self.Degree,
            'Units': self.Units,
            'YearGraduated': self.YearGraduated,
            'From': self.From,
            'To': self.To,
            'Scholarshi_Honor': self.Scholarshi_Honor,
            'is_delete': self.is_delete,
