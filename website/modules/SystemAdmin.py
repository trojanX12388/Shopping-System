...
def sysadminAM_update_requests():
    ...
    if request.method == 'POST':
        ...
        requesting = request.form.get('requesting')
            ...
            if status == "pending":
                ...
                if acctype == "FacultyId":
                    add_notif = FISUser_Notifications(
                        ...
                        notif_by = None,
                        notifier_type = "System",
                        Notification = "Request approved for "+ requesting,
                        )
            ...
            if status == "pending":
                ...
                if acctype == "FacultyId":
                    add_notif = FISUser_Notifications(
                        ...
                        notif_by = None,
                        notifier_type = "System",
                        Notification = "Request declined for "+ requesting,
                        )
