...
from website.models import FISAdmin, FISEvaluations, FISUser_Notifications, FISAdmin, FISEvaluation_Periods
...
def aFS_H():
    # INITIALIZING DATA FROM USER LOGGED IN ACCOUNT    
        ...
        first_sem_evalperiod = FISEvaluation_Periods.query.filter_by(SemesterId=101).first() 
        second_sem_evalperiod = FISEvaluation_Periods.query.filter_by(SemesterId=102).first() 
        summer_sem_evalperiod = FISEvaluation_Periods.query.filter_by(SemesterId=103).first() 
           
                      
        return render_template("Admin-Home-Page/Feedback-Survey/index.html", 
                               User= username.FirstName + " " + username.LastName,
                               user= current_user,
                               first_sem_evalperiod = first_sem_evalperiod.Month_Value,
                               second_sem_evalperiod = second_sem_evalperiod.Month_Value,
                               summer_sem_evalperiod = summer_sem_evalperiod.Month_Value,
